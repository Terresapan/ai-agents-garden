        ...
        <Card className="w-full h-[500px] bg-black/[0.96] relative overflow-hidden mt-16">
          ...
          <div className="flex h-full flex-col md:flex-row">
            ...
            <div className="flex-1 p-8 relative z-10 flex flex-col justify-center">
              <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">Agentic Workflow</h1>
              <p className="mt-4 text-neutral-300 max-w-lg font-thin">Solve Real World Business Problem</p>
            </div>
